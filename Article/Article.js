...
const data = [
  ...
  {  
    title: 'Why Hamburgers are better',
...
*/
function createArticle(titl, dat, p1Content, p2Content, p3Content){
  const article = 
  ...
  p1.textContent = p1Content
  p2.textContent = p2Content
  p3.textContent = p3Content
