...
* [T] Add your team lead as collaborator on Github.
* [T] Clone your OWN version of the repository (Not Lambda's by mistake!).
* [T] Create a new branch: git checkout -b `<firstName-lastName>`.
* [T] Implement the project on your newly created `<firstName-lastName>` branch, committing changes regularly.
